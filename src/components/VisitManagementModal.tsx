...
export const VisitManagementModal: React.FC<VisitManagementModalProps> = ({ isOpen, onClose, property }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Gestionar Visitas - {property.title}</DialogTitle>
          <DialogDescription>
            Gestiona las visitas a esta propiedad y mantén un registro detallado.
          </DialogDescription>
        </DialogHeader>
          ...
          <TabsContent value="new" className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setNewVisit(prev => ({ ...prev, status: value as VisitStatus }))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setNewVisit(prev => ({ ...prev, duration: parseInt(e.target.value) || 60 }))}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Select
                  value={newVisit.contactMethod}
                  onValueChange={(value) => setNewVisit(prev => ({ ...prev, contactMethod: value }))}
                >
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setNewVisit(prev => ({ ...prev, contactPerson: e.target.value }))}
